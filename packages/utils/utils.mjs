 ...
 * containing the WASM and worker files, defaults to @imagecapture-main
 * @param {string} [sdk] the npm package to get the resources from
 */
export function getResourcesPath(sdk = "imagecapture-main") {
...
/**
 * Symlinks the resources from `@imagecapture-main` to the target
 * directory
